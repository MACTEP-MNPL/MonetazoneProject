  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-[1.1rem] font-medium",
        ...
        head_row: "flex",
        head_cell:
          "text-neutral-500 rounded-md w-9 font-normal text-[1.1rem] dark:text-neutral-400",
        ...
        day: cn(
          ...
          "text-[1.1rem] h-9 w-9 p-0 font-normal aria-selected:opacity-100"
        ),
